...
- Complete Git history scan with `--all`: six commits scanned in the final isolated clone, no leaks found.
- Gitleaks report redaction: 100 percent.
- Working-tree report: `[]`.
- History report: `[]`.
- Corrected hosted and final fresh-clone scans: no leaks; nine commits scanned in the fresh clone.

Each empty JSON report is three bytes with SHA-256
`37517e5f3dc66819f61f5a7bb8ace1921282415f10551d2defa5c3eb0985b570`.
The immediate-parent isolated-clone standalone scan log is 407 bytes with SHA-256
