...
class RecoverySourceTests(unittest.TestCase):
    ...
    def test_terraform_uses_only_the_checked_in_per_node_lifecycle_map(self) -> None:
        ...
        self.assertEqual(management.count('instance_type       = "CPU.4V.16G"'), 2)
        self.assertEqual(management.count('resource_expiry_utc = "2026-08-24T21:00:00Z"'), 2)
        self.assertEqual(management.count('instance_type       = "CPU.8V.32G"'), 1)
        self.assertEqual(management.count('resource_expiry_utc = "2026-08-27T21:00:00Z"'), 1)
