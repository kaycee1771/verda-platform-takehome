...
| Rancher | GitOps-managed Rancher | pod Ready, TLS endpoint reachable | [Rancher](../evidence/final/03-rancher.md) | PASS |
...
| Monitoring | Prometheus, Alertmanager, Grafana | 42/46 targets up; dashboard source loaded | [monitoring](../evidence/final/07-prometheus-and-dashboard.md) | PASS |
