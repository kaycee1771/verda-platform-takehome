...
app.kubernetes.io/name: stage-a-smoke
app.kubernetes.io/instance: stage-a-smoke
...
{{- end -}}
{{- if not (regexMatch (printf "^stage-a-%s\\.([0-9]{1,3}-){3}[0-9]{1,3}\\.sslip\\.io$" .Values.environment) .Values.hostname) -}}
{{- fail "hostname must be stage-a-<environment>.<IPv4-with-dashes>.sslip.io" -}}
{{- end -}}
{{- $encoded := trimSuffix ".sslip.io" (trimPrefix (printf "stage-a-%s." .Values.environment) .Values.hostname) -}}
